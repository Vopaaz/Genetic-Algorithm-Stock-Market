...
\emph{A buy signal is triggered when the Closing Price crosses the 28 moveing average to the Upside.}

\emph{A sell signal is triggered when the Closing Price crosses the moveing average to the Downside.}
\cite{genetic-algorithms-for-predicting-the-egyptian-stock-market}
...
\emph{CCI = (Today's Typical Price - Today's 18th period moving average) / (0.015 * average of absolute value of (each of 18 period day's typical price - 18th day's simple moving average))}
\cite{stock-market-prediction-model-using-TPWS}
