...
It has already be implemented in different fields and makes a good performance.\cite{CHAN2005364} \cite{Wu_2013}
...
Elitism can reduce genetic drift while also increase the selection pressure. \cite{1223577}

Besides three mentioned variants, there are also many other variants of genetic algorithm, for example, parallel genetic algorithm. \cite{Goldberg:1989:SPS:645512.657266}
