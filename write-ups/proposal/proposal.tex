...
Now that we have had a outline of our project, we will get down to it right now.
To figure out the result, we need to scratch and process the data, construct algorithm model and analysis the result.
